                ...
                <li v-for="(item, index) in productList" :key="index">
                  <div class="cart-tab-1">
                    ...
                    <div class="cart-item-title">
                      ...
                      <div class="item-introduce" v-html="item.productIntroduce"></div>
                    </div>
                  </div>
      ...
      this.productList = [
        {
          ...
          productName: 'NB-124',
          productIntroduce:
            '品类：晶瓷画<br>尺寸：77X117cm<br>画框：金色铝合金',
          productPrice: 1175,
          productQuantity: 1,
          productImage: require('../../assets/images/NB-124.jpg')
        },
        {
          productId: '600100002115',
          productName: 'NB-124',
